...
document.getElementById("switch-difraction").addEventListener("change", function (ev) {
    quazimonochromatic = this.checked
    calculateresults()
})
...
document.getElementById("slider-delta-lambda").addEventListener("input", function (ev) 
{
    document.getElementById("delta-lambda").innerHTML = this.value
    quazi.deltamin = -this.value/2
    quazi.deltamax = this.value/2
    calculateslits()
    calculateresults()
})

document.getElementById("slider-delta-lambda").addEventListener("change", function (ev) 
{
    document.getElementById("delta-lambda").innerHTML = this.value
    quazi.deltamin = -this.value/2
    quazi.deltamax = this.value/2
